...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<A-s>", builtin.find_files, { desc = "[S]earch [F]iles" })
	...
	{ -- You can easily change to a different colorscheme.
		...
		--
		-- If you want to see what colorschemes are already installed, you can use `:`Telescope colorschemeelescope colorscheme.
